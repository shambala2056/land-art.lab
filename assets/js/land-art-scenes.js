...
const SIZES={
  A:{rad:1.000,h:PAD,area:400,pots:400,trees:1200,price:40000000,n:263},
  B:{rad:0.805,h:PAD,area:260,pots:260,trees:780, price:26000000,n:170},
  C:{rad:0.550,h:PAD,area:120,pots:120,trees:360, price:12000000,n:80},
  D:{rad:0.470,h:PAD,area:90, pots:90,  trees:270, price:9000000, n:58},
  E:{rad:0.337,h:PAD,area:45, pots:45,  trees:135, price:4500000, n:44},
  F:{rad:0.172,h:PAD,area:12, pots:12,  trees:36,  price:1200000, n:14}
};
...
(function(){
  ...
  SHAPE.forEach(function(h){
    ...
    CELLS.push({code:code,sizeKey:key,S:S,themed:!!th,cat:th?th[1]:'flora',
      ...
      role:th?th[2]:S.area+' m² planted — '+S.pots+' pits, '+S.trees+' elms, ten years of maintenance and irrigation',
